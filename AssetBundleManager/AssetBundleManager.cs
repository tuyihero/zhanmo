...
namespace AssetBundles
{
    ...
    public class AssetBundleManager : MonoBehaviour
    {
        ...
        public static List<AssetBundleLoadOperation> m_InProgressOperations = new List<AssetBundleLoadOperation>();
        ...
        private static string GetStreamingAssetsPath()
        {
            if (Application.isEditor)
                return "file://" + Application.streamingAssetsPath; // Use the build output folder directly.
        ...
        public static void SetSourceAssetBundleDirectory(string relativePath)
        {
            ...
            Debug.Log("SetSourceAssetBundleDirectory:" + BaseDownloadingURL + "," + relativePath);
        }
